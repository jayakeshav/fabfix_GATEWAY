package edu.uci.ics.jkotha.service.api_gateway.configs;

import edu.uci.ics.jkotha.service.api_gateway.logger.ServiceLogger;

import static edu.uci.ics.jkotha.service.api_gateway.GatewayService.ANSI_RED;
import static edu.uci.ics.jkotha.service.api_gateway.GatewayService.ANSI_RESET;
...
public class BillingConfigs {
    ...
    public BillingConfigs(ConfigsModel cm) throws NullPointerException {
        ...
        if (scheme == null) {
            System.err.println(ANSI_RED + "Billing scheme not found in configuration file." + ANSI_RESET);
        } else {
        ...
        if (hostName == null) {
            System.err.println(ANSI_RED + "Billing host name not found in configuration file." + ANSI_RESET);
        } else {
        ...
        if (path == null) {
            System.err.println(ANSI_RED + "Billing path not found in configuration file." + ANSI_RESET);
        } else {
        ...
        if (EPCartInsert == null) {
            ...
            System.err.println("[Billing][EP] Clear Insert: " + EPCartInsert);
        }
    ...
    public void currentConfigs() {
        ...
        ServiceLogger.LOGGER.config("[Billing][EP] Clear Cart: " + EPCartInsert);
